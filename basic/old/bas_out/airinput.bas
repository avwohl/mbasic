...
30 BL$=CHR$(7):E$=CHR$(27):ER$=E$+"E":P$=E$+"p":Q$=E$+"q":G$=E$+"F":NG$=E$+"G":Y$=E$+"Y":L$=E$+"l":J$=E$+"j":K$=E$+"k":J1$=E$+"J":U=1.79049
...
1790 PI=J
1800 IF FD>1  THEN REC=(J MOD5)+1:SS=J \ 5:GET#1,REC:GOSUB2090:FD=FD+1:RO=RO+1
1810 IF FD=0  THEN FD=1:REC=(J MOD5)+1:SS=J \ 5:GET#1,REC
1820 NEXT J
...
1960 IF ID$(J)=AP$  THEN FD=FD+1:RO=8+FD:REC=(J MOD5)+1:SS=J \ 5:GET#1,REC:PI=J:GOSUB2090
1970 NEXT J
...
2050 PI=TI
2060 REC=(PI MOD5)+1:SS=PI \ 5:GET#1,REC
...
3030 Y6=Y4-Y5
3040 Y7=Y6*60
3050 REC=(PI MOD5)+1:SS=PI \ 5:GET#1,REC
3060 RO=3:GOSUB2090
3070 LSET D1$=LOF(Y)
3080 LSET M1$=MKI$(Y2)
3090 LSET D$=LOF(Y5)
