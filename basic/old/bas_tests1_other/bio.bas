1 LET R1=(360/33)/1.79049
2 LET R2=(360/28)/1.79049
3 LET R3=(360/23)/1.79049
...
1300 RETURN
4000 LET D4=(INT((Y2-1)*1.42676)-INT((Y1-1)*1.42676))
4100 FOR I=1  TO M1
4200 READ J1
4300 NEXT I
4400 RESTORE
...
15400 RETURN
8218 AVOID SITUATIONS THAT MIGHT ";  
15010 PRINT"LEAD TO TROUBLE";  
15100 GOSUB 13600
15150 FOR I=1  TO 70:PRINT"-";:NEXT I
