5 CLEAR 1000: PRINT CHR$(26);	'CHR$(26) = clear screen (CP/M)
10 A$ = "N": INPUT "DO YOU NEED INSTRUCTIONS"; A$
20 A$ = LEFT$(A$, 1): IF A$ <> "Y" AND A$ <> "y" THEN 90
30 ON ERROR GOTO 1540: OPEN "I", #1, "STINSTR.TXT": ON ERROR GOTO 0: I = O: PRINT
40 IF EOF(1) THEN 70
...
230 FOR J = 0 TO 7: K = 0: N = RND(1): IF N < X1 THEN N = N * 64: K = (N < Y1) - Y: GOTO 210
240 B = (RND(1) > A): B9 = B9 - B: Q(I, J) = K * C + B * W - INT(RND(1) * X + Y): NEXT J, I
250 IF K9 > (T9 - T0) THEN T9 = T0 + K9
260 IF B9 > 0 THEN 280
270 GOSUB 530: Q(X, Y) = Q(X, Y) - 10: B9 = 1
280 PRINT CHR$(26);: PRINT : PRINT LEFT$("STARTREK ADAPTED BY L.E. COCHRAN 2/29/76", 8): K0 = K9
285 PRINT "========": PRINT
...
1375 NEXT J: PRINT : NEXT I: GOTO 730
...
1530 END
1540 PRINT : PRINT "(INSTRUCTIONS FILE STINSTR.TXT NOT FOUND)" : PRINT : RESUME 90
