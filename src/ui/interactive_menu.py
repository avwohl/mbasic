    ...
    def __init__(self, parent_ui):
        ...
        self.menus = {
            ...
            'Edit': [
                ...
                (f'Insert Line    {key_to_display(kb.INSERT_LINE_KEY)}', '_smart_insert_line'),
                (f'Renumber...    {key_to_display(kb.RENUMBER_KEY)}', '_renumber_lines'),
                ('---', None),
            ...
            'Run': [
                ...
                (f'Step Statement {key_to_display(kb.STEP_KEY)}', '_debug_step'),
