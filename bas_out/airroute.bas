...
560 :REMARK
570 :REMARKsearch index for match & get
580 RO=I+4
590 FD=0
600 FOR J=0  TO IM
...
630 PI=J
640 IF FD>1  THEN REC=(J MOD5)+1:SS=J \ 5:GET#1,REC:GOSUB 780:FD=FD+1:RO=RO+1
650 IF FD=0  THEN FD=1:REC=(J MOD5)+1:SS=J \ 5:GET#1,REC
660 NEXT J
