...
350 [9E] SR$;:RETURN
360 [9E]:RETURN
1000 A=50:GOTO20:REM RESERVEER STRINGRUIMTE
1010 GOSUB5000:REM UITLEG
1015 GOSUB100
1020 J=0:K=0:Q=0:I=0:D=0
1030 PRINT"* Oplossen LINEAIR STELSEL *":PRINT
1040 PRINT"ORDE ";:INPUTN
1050 M=N-1
1060 DIMA(M,N+1):PRINT
1070 FORK=0TON
1080 :IFK=N THEN PRINT"vektor";:GOTO1100
1090 :PRINT"kolom";K+1;
1100 :FORJ=0TOM
1110 ::GOSUB120:HO=13:GOSUB110
1120 ::PRINT"#";J+1;
1130 ::INPUTA(J,K)
1140 :NEXTJ:PRINT
1150 NEXTK
1200 FORI=0TOM:A(I,N+1)=I:NEXT
1210 D=1
1220 FORK=0TON-2
1230 :I=K:Q=ABS(A(K,K))
1240 :FORJ=1TOM-K
1250 ::R=ABS(A(J+K,K))
1260 ::IFQ<R THENQ=R:I=K+J
1270 :NEXTJ
1280 :IFI=K THEN1330
1290 :D=-D
1300 :FORJ=0TON+1
1310 ::Q=A(K,J):A(K,J)=A(I,J):A(I,J)=Q
1320 :NEXTJ
1330 :D=D*A(K,K):IFD=0THEN1420
1340 :FORI=M TOK+1STEP-1
1350 ::Q=A(I,K)/A(K,K)
1360 ::A(I,K)=Q
1370 ::FORJ=K+1TOM
1380 :::A(I,J)=A(I,J)-Q*A(K,J)
1390 ::NEXTJ
1400 :NEXTI
1410 NEXTK
1420 D=D*A(M,M)
1430 PRINT"determinant= "D:PRINT
1440 IFD=0THEN PRINT"geen oplossing":PRINT:GOTO2500
1450 :
1500 FORK=0TOM
1510 :Q=A(K,N)
1520 :J=0
1530 :IFJ<K THENQ=Q-A(J,N)*A(K,J):J=J+1:GOTO1530
1540 :A(K,N)=Q
1550 NEXTK
1560 FORK=M TO0 STEP-1
1570 :Q=A(K,N)
1580 :J=M
1590 :IFJ>K THENQ=Q-A(J,N)*A(K,J):J=J-1:GOTO1590
1600 :A(K,N)=Q/A(K,K)
1610 NEXTK
1620 :
2000 FORI=0TOM
2010 :SR=I+1:GOSUB300
2020 :PRINT"x";SR$;" = ";A(I,N)
2030 NEXTI
2040 :
2100 PRINT:PRINT"Wilt u een andere vektor ";
2110 GOSUB4000
2120 IFA$="n" ORA$="N" THEN2500
2130 PRINT"Vektor";
2140 FORK=0TOM
2150 :I=0
2160 :IFA(I,N+1)<>K THENI=I+1:GOTO2160
2170 :GOSUB120:HO=13:GOSUB110
2180 :PRINT"#";K+1;
2190 :INPUTA(I,N)
2200 NEXT
2210 PRINT:GOTO1500
...
5380 RETURN
5390 :
6000 HO=0:VE=24:GOSUB110
6010 PRINT"druk op de spatiebalk voor het vervolg";
6020 GOSUB210:IFIN$<>" " THEN6020
6030 RETURN
6040 :
10000 REM
