...
60 PRINT "THROW",TAB(20);"DESCRIPTION";TAB(45);"PROBABLE SC OR E"
...
290 S(I)=S(I)+B: PRINT "TOTAL SC OR E =";S(I): NEXT I
300 FOR I=1 TO N
310 IF S(I)>=200 THEN M=M+1: W(M)=I
320 NEXT I
330 IF M=0 THEN 150
340 PRINT: PRINT "WE HAVE A WINNER!!": PRINT
350 FOR I=1 TO M: PRINT A$(W(I));" SC OR ED";S(W(I));"POINTS.": NEXT I
