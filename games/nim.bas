...
320 PRINT "ANY NUMBER OF OBJECTS ARE REMOVED FROM ON E PILE BY YOU AND"
...
350 PRINT "TAKE AT LEAST ON E OBJECT, AND YOU MAY TAKE OBJECTS FROM"
360 PRINT "ON LY ON E PILE ON A SINGLE TURN.  YOU MUST SPECIFY WHETHER"
