...
1252 PRINT"   THE GALAXY BEF OR E THEY CAN ATTACK FEDERATION HEADQUARTERS"
...
2160 NEXT I:PRINT"ENTER ON E OF THE FOLLOWING:"
2180 PRINT"  NAV  (TO SET COURSE)"
2190 PRINT"  SRS  (FOR SH OR T RANGE SENSOR SCAN)"
...
3800 PRINT"LT. UHURA REP OR TS MESSAGE FROM STARFLEET COMMAND:"
...
5630 E=E+S-X:S=X:PRINT"DEFLECTOR CONTROL ROOM REP OR T:"
...
6420 REM SH OR T RANGE SENSOR SCAN & STARTUP SUBROUTINE
