...
9 REM  CONVERSION TO MITS BASIC BY STEVE N OR TH
...
2020 PRINT "THE PAWNS ARE MOVED AS IN CHESS - ON E SPACE FOR WARD TO"
2030 PRINT "AN EMPTY SPACE OR ON E SPACE FOR WARD AND DIAGONALLY TO"
...
2100 PRINT "THE COMPUTER STARTS A SERIES OF GAMES KNOWING ON LY WHEN"
2105 PRINT "THE GAME IS WON (A DRAW IS IMPOSSIBLE) AND HOW TO MOVE."
2110 PRINT "IT HAS NO STRATEGY AT FIRST AND JUST MOVES R AND OMLY."
2120 PRINT "HOWEVER, IT LEARNS FROM EACH GAME.  THUS, WINNING BECOMES"
2130 PRINT "M OR E AND M OR E DIFFICULT.  ALSO, TO HELP OFFSET YOUR"
...
2180 PRINT: PRINT "FOR EXAMPLE, TO MOVE YOUR RIGHTMOST PAWN FOR WARD,"
2190 PRINT "YOU WOULD TYPE 9,6 IN RESPONSE TO THE QUESTION"
2200 PRINT "'YOUR MOVE ?'.  SINCE I'M A GOOD SP OR T, YOU'LL ALWAYS"
