...
205 PRINT "TOWER, ON E AT A TIME, NEVER PUTTING A LARGER DISK ON A"
...
520 PRINT "ILLEGAL ENTRY... YOU MAY ON LY TYPE 3,5,7,9,11,13, OR 15."
...
660 NEXT Q
670 GOTO 700
680 PRINT "THAT DISK IS BELOW ANOTHER ON E.  MAKE ANOTHER CHOICE."
690 GOTO 480
700 E=0
...
760 PRINT "I ON LY ALLOW ON E MISTAKE.": GOTO 705
...
820 NEXT R
830 GOTO 880
835 REM *** CHECK IF DISK TO BE PLACED ON A LARGER ON E
840 IF D<T(R,N) THEN 880
850 PRINT "YOU CAN'T PLACE A LARGER DISK ON TOP OF A SMALLER ON E,"
...
1100 PRINT "S OR RY, BUT I HAVE ORDERS TO STOP IF YOU MAKE M OR E THAN"
1110 PRINT "128 MOVES.": STOP
1120 IF M<>2^S-1 THEN 1140
1130 PRINT:PRINT "CONGRATULATIONS!!":PRINT
1140 PRINT "YOU HAVE PERF OR MED THE TASK IN";M;"MOVES."
