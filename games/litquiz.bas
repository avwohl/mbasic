...
44 PRINT "S OR RY...FIGARO WAS HIS NAME.": GOTO 50
...
57 R=R+1
60 PRINT: PRINT
61 PRINT "IN THE WIZARD OF OS, D OR OTHY'S DOG WAS NAMED"
...
75 GOTO 80
76 PRINT "GOOD MEM OR Y!"
77 R=R+1
80 PRINT:PRINT
85 IF R=4 THEN 100
90 IF R<2 THEN 200
92 PRINT "NOT BAD, BUT YOU MIGHT SPEND A LITTLE M OR E TIME"
