...
190  PRINT "REMEMBER THAT ALL FACT OR S ARE INTERRELATED AND THAT YOUR"
200  PRINT "RESPONSES COULD CHANGE HIST OR Y. FACTS AND FIGURES USED ARE"
...
280  PRINT "        (2) FOR TIFICATION AGAINST FRONTAL ATTACK"
290  PRINT "        (3) FOR TIFICATION AGAINST FLANKING MANEUVERS"
...
1195  PRINT
1200  REM - ON LY IN PRINTOUT IS CONFED INFLATION = I1+15%
...
1470  PRINT "THINK AGAIN! YOU HAVE ON LY $"D(I)
1480  GOTO 1270
...
1590  GOTO 1620
1600  PRINT "      UNION ";
1610  REM - FIND M OR ALE
1620  LET O=((2*F(Z)^2+H(Z)^2)/F1^2+1)
1630  IF O<10 THEN 1660
1640  PRINT "M OR ALE IS HIGH"
1650  GOTO 1700
1660  IF O<5 THEN 1690
1670  PRINT "M OR ALE IS FAIR"
1680  GOTO 1700
1690  PRINT "M OR ALE IS POOR"
...
2070  REM : SIMULATED LOSSES-N OR TH
...
2640  REM - CUMULATIVE BATTLE FACT OR S WHICH ALTER HIST OR ICAL
...
3000  PRINT "HIST OR ICAL LOSSES",INT(P1+.5),INT(P2+.5)
...
3280  PRINT Y2
3290  RETURN
3300  REM LEARN  PRESENT STRATEGY, START FOR GETTING OLD ON ES
...
3400  LET S(Y)=S(Y)+S0
3410  RETURN
3420  REM - HIST OR ICAL DATA...CAN ADD M OR E (STRAT.,ETC) BY INSERTING
...
3500  DATA "MURFREESB OR O",38000.,45000.,11000,12000,1
3510  DATA "CHANCELL OR SVILLE",32000,90000.,13000,17197,2
...
3580  PRINT "JULY 21, 1861.  GEN. BEAUREGARD, COMM AND ING THE SOUTH, MET"
3590  PRINT "UNION FOR CES WITH GEN. MCDOWELL IN A PREMATURE BATTLE AT"
...
3660  PRINT "OFFENSIVE THROUGHOUT THE BATTLE AND FOR CED GEN. MCCLELLAN"
3670  PRINT "AND THE UNION FOR CES AWAY FROM RICHMOND."
3680  GOTO 1150
3690  PRINT "AUG 29-30, 1862.  THE COMBINED CONFEDERATE FOR CES UNDER";
3695  PRINT " LEE"
3700  PRINT "AND JACKSON DROVE THE UNION FOR CES BACK INTO WASHINGTON."
3710  GOTO 1150
3720  PRINT "SEPT 17, 1862.  THE SOUTH FAILED TO INC OR P OR ATE MARYLAND"
...
3785  PRINT "BATTLE."
3790  GOTO 1150
3800  PRINT "MAY 1-6, 1863.  THE SOUTH HAD A COSTLY VICT OR Y AND LOST"
3810  PRINT "ON E OF THEIR OUTST AND ING GENERALS, 'STONEWALL' JACKSON."
3820  GOTO 1150
...
3870  PRINT "COST THEM ON E OF THE MOST CRUCIAL BATTLES OF THE WAR."
3880  GOTO 1150
3890  PRINT "SEPT. 15, 1863. CONFUSION IN A FOR EST NEAR CHICKAMAUGA LED"
3900  PRINT "TO A COSTLY SOUTHERN VICT OR Y."
3910  GOTO 1150
