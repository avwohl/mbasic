...
134 PRINT "BE GENERATED R AND OMLY AND THEREF OR E THIS MODEL DOES NOT" 
...
137 PRINT "IN YOUR P OR TFOLIO WILL BE PRINTED.  FOLLOWING THIS, THE" 
...
267 REM R AND OMIZE SIGN OF FIRST TREND SLOPE (A)
268 IF RND(X)>.5 THEN 270 
269 LET A=-A
270 REM R AND OMIZE INITIAL VALUES 
280 GOSUB 830 
285 REM INITIAL P OR TFOLIO CONTENTS 
290 FOR I=1 TO 5
300 LET P(I)=0
305 LET Z(I)=0
310 NEXT I
...
335 LET C=10000 
338 REM PRINT INITIAL P OR TFOLIO
...
358 PRINT "CENSURED BOOKS ST OR E","  CBS",S(5) 
360 PRINT 
...
396 PRINT "NEW Y OR K STOCK EXCHANGE AVERAGE: "Z5 
397 GOTO 399 
398 PRINT "NEW Y OR K STOCK EXCHANGE AVERAGE: "Z5"NET CHANGE"Z6
399 PRINT 
...
658 PRINT "YOU HAVE USED $"-C5" M OR E THAN YOU HAVE." 
660 GOTO 420
674 LET C=C5
675 REM CALCULATE NEW P OR TFOLIO  
680 FOR I=1 TO 5
690 LET P(I)=P(I)+Z(I)
700 NEXT I
710 REM CALCULATE NEW STOCK VALUES 
720 GOSUB 830 
750 REM PRINT P OR TFOLIO
...
830 REM R AND OMLY PRODUCE NEW STOCK VALUES BASED ON PREVIOUS
831 REM DAY'S VALUES 
832 REM N1,N2 ARE R AND OM NUMBERS OF DAYS WHICH RESPECTIVELY
...
857 LET E2=1
860 REM DEDUCT ON E DAY FROM N1 AND N2
861 LET N1=N1-1 
862 LET N2=N2-1 
...
970 NEXT I
972 REM AFTER T8 DAYS R AND OMLY CHANGE TREND SIGN AND SLOPE 
973 LET T8=T8-1 
974 IF T8<1 THEN 985
980 RETURN
985 REM R AND OMLY CHANGE TREND SIGN AND SLOPE (A), AND DURATION 
986 REM OF TREND (T8)
