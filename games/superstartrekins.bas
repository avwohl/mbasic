...
100 PRINT
110 PRINT"1. WHEN YOU SEE \COMMAND ?\ PRINTED, ENTER ON E OF THE LEGAL"
120 PRINT"     COMM AND S (NAV,SRS,LRS,PHA,TOR,SHE,DAM,COM, OR XXX)."
130 PRINT"2. IF YOU SHOULD TYPE IN AN ILLEGAL COMMAND, YOU'LL GET A SH OR T"
140 PRINT"     LIST OF THE LEGAL COMM AND S PRINTED OUT."
150 PRINT"3. SOME COMM AND S REQUIRE YOU TO ENTER DATA (FOR EXAMPLE, THE"
160 PRINT"     'NAV' COMMAND COMES BACK WITH 'COURSE (1-9) ?'.)  IF YOU"
170 PRINT"     TYPE IN ILLEGAL DATA (LIKE NEGATIVE NUMBERS), THAN COMMAND"
180 PRINT"     WILL BE AB OR TED"
190 PRINT
...
340 PRINT"PLANETS."
360 PRINT
370 PRINT"     YOU HAVE THE FOLLOWING COMM AND S AVAILABLE TO YOU AS CAPTAIN"
...
480 PRINT"                                            COURSE"
490 PRINT"     ON E WARP FACTOR IS THE SIZE OF "
500 PRINT"     ON E QUADTANT.  THEREF OR E, TO GET"
510 PRINT"     FROM QUADRANT 6,5 TO 5,5, YOU WOULD"
520 PRINT"     USE COURSE 3, WARP FACTOR 1."
530 PRINT
540 PRINT"\SRS\ COMMAND = SH OR T RANGE SENSOR SCAN"
...
600 PRINT"         *  = STAR"
605 PRINT
610 PRINT"     A CONDENSED 'STATUS REP OR T' WILL ALSO BE PRESENTED."
620 PRINT
640 PRINT"\LRS\ COMMAND = LONG RANGE SENSOR SCAN"
650 PRINT"     SHOWS CONDITIONS IN SPACE FOR ON E QUADRANT ON EACH SIDE"
...
770 PRINT
780 PRINT"\TOR\ COMMAND = PHOTON T OR PEDO CONTROL"
790 PRINT"     T OR PEDO COURSE IS THE SAME AS USED IN WARP ENGINE CONTROL"
...
840 PRINT"     COMPUTE T OR PEDO TRAJECT OR Y FOR YOU (OPTION 2)"
850 PRINT
...
900 PRINT
910 PRINT"\DAM\ COMMAND = DAMMAGE CONTROL REP OR T"
920 PRINT"     GIVES THE STATE OF REPAIR OF ALL DEVICES.  WHERE A NEGATIVE"
930 PRINT"     'STATE OF REPAIR' SHOWS THAT THE DEVICE IS TEMP OR ARILY"
940 PRINT"     DAMAGED."
950 PRINT
960 PRINT"\COM\ COMMAND = LIBRARY-COMPUTER"
970 PRINT"     THE LIBRARY-COMPUTER CONTAINS SIX OPTIONS:"
980 PRINT"     OPTION 0 = CUMULATIVE GALACTIC REC OR D"
990 PRINT"        THIS OPTION SHOWES COMPUTER MEM OR Y OF THE RESULTS OF ALL"
1000 PRINT"        PREVIOUS SH OR T AND LONG RANGE SENSOR SCANS"
1010 PRINT"     OPTION 1 = STATUS REP OR T"
1020 PRINT"        THIS OPTION SHOWS THE NUMBER OF KLINGONS, STARDATES,"
1030 PRINT"        AND STARBASES REMAINING IN THE GAME."
1040 PRINT"     OPTION 2 = PHOTON T OR PEDO DATA"
...
1110 PRINT"        THIS OPTION ALLOWS YOU TO ENTER CO OR DINATES FOR"
