...
5 PRINT:PRINT "DISTRIBUTE YOUR FOR CES."
6 PRINT ,"ME","  YOU"
7 PRINT "ARMY",30000,
8 INPUT A
9 PRINT "NAVY",20000,
...
255 E=INT(E/3)
260 GOTO 500
270 PRINT "YOU SUNK ON E OF MY PATROL BOATS, BUT I WIPED OUT TWO"
275 PRINT "OF YOUR AIR FOR CE BASES AND 3 ARMY BASES."
280 A=INT(A/3)
285 C=INT(C/3)
290 E=INT(2*E/3)
293 GOTO 500
...
378 F=INT(F/3)
379 GOTO 500
380 PRINT "YOU WIPED OUT ON E OF MY ARMY PATROLS, BUT I DESTROYED"
...
1010 PRINT "ARMY=1  NAVY=2  AIR FOR CE=3"
1020 INPUT G
...
1720 GOTO 1770
1750 PRINT "I SUNK TWO OF YOUR BATTLESHIPS, AND MY AIR FOR CE"
...
1820 GOTO 1850
1830 PRINT "MY NAVY AND AIR FOR CE IN A COMBINED ATTACK LEFT"
1831 PRINT "YOUR COUNTRY IN SHAMBLES."
1835 A=A/3
1837 B=B/3
1840 C=C/3
1845 GOTO 2000
1850 PRINT "ON E OF YOUR PLANES CRASHED INTO MY HOUSE. I AM DEAD."
