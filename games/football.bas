...
140 PRINT "PRESENTING N.F.U. FOOTBALL (NO FOR TRAN USED)"
145 PRINT:PRINT
...
210 PRINT "BOTH TEAMS HAVING THE SAME PLAYS. THE M OR E SIMILAR THE"
220 PRINT "PLAYS THE LESS YARDAGE GAINED.  SC OR ES ARE GIVEN"
223 PRINT "WHENEVER SC OR ES ARE MADE. SC OR ES MAY ALSO BE OBTAINED"
...
290 PRINT:PRINT "PLEASE INPUT SC OR E LIMIT ON GAME";:INPUT E
...
1810 PRINT: PRINT "TEAM 1 SC OR E IS";H(1)
1820 PRINT "TEAM 2 SC OR E IS";H(2): PRINT
