...
7 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
8 PRINT:PRINT:PRINT
...
30 PRINT " (30 FT.) JUMP SHOT; 2. SH OR T (15 FT.) JUMP SHOT; 3. LAY"
...
515 PRINT "FINAL SC OR E: DARTMOUTH:";S(1);"  ";O$;":";S(0)
520 STOP
600 PRINT
...
4060 PRINT "SHOOTER MAKES ON E SHOT AND MISSES ON E."
4070 S(1-P)=S(1-P)+1
4080 GOTO 4040
...
5140 GOTO 425
6000 S(0)=S(0)+2
6010 PRINT "SC OR E: ";S(1);"TO";S(0)
6020 RETURN
7000 S(1)=S(1)+2
7010 GOSUB 6010
7020 RETURN
8000 PRINT:PRINT "   ***** END OF FIRST HALF *****":PRINT
8010 PRINT "SC OR E: DARTMOUTH:";S(1);"  ";O$;":";S(0)
8015 PRINT
8016 PRINT
8020 GOTO 370
9999 END
