...
210 S=0
220 GOTO 370
230 PRINT "MINIMUM ELEVATION IS ON E DEGREE."
240 GOTO 390
250 PRINT "MAXIMUM ELEVATION IS 89 DEGREES."
260 GOTO 390
270 PRINT "OVER TARGET BY ";ABS(E);"YARDS."
280 GOTO 390
290 PRINT "SH OR T OF TARGET BY "ABS(E);"YARDS."
300 GOTO 390
...
340 Z=Z+1
345 PRINT
350 PRINT "THE FOR WARD OBSERVER HAS SIGHTED M OR E ENEMY ACTIVITY..."
360 GOTO 200
...
495 PRINT "BETTER GO BACK TO FOR T SILL FOR REFRESHER TRAINING!"
