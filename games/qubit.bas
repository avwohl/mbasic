...
250 PRINT "INC OR RECT ANSWER.  PLEASE TYPE 'YES' OR 'NO'";
260 GOTO 220
265 PRINT
...
480 PRINT "INC OR RECT ANSWER.  PLEASE TYPE 'YES' OR 'NO'.";
490 GOTO 450
500 PRINT " "
510 PRINT "YOUR MOVE";
520 INPUT J1
...
1540 PRINT "INC OR RECT ANSWER. PLEASE TYPE 'YES' OR 'NO'";
1550 GOTO 1510
1560 END
...
2740 RETURN
2750 PRINT"INC OR RECT MOVE, RETYPE IT--";
2760 GOTO 520
2770 END
