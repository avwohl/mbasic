...
240 PRINT "1= SIMPLE RUN; 2= TRICKY RUN; 3= SH OR T PASS;"
...
360 DATA "YARD LINE"," SIMPLE RUN"," TRICKY RUN"," SH OR T PASS"
...
520 NEXT E
530 PRINT "INC OR RECT ANSWER.  PLEASE TYPE 'KICK' OR 'RECIEVE'";
540 GOTO 480
550 IF E=2 THEN 580
560 LET P=1
580 LET X=40+(1-P)*20
...
920 PRINT "FINAL SC OR E:  ";O$(0);": ";S(0);"  ";O$(1);": ";S(1)
930 STOP
