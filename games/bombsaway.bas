8 PRINT "YOU ARE A PILOT IN A W OR LD WAR II BOMBER."
...
30 INPUT "YOUR TARGET -- ALBANIA(1), GREECE(2), N OR TH AFRICA(3)";B
...
170 PRINT "YOU'RE CHASING THE BISMARK IN THE N OR TH SEA." : GOTO 280
