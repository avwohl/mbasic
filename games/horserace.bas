100 PRINT TAB(31);"H OR SERACE"
110 PRINT TAB(15);"CREATIVE COMPUTING  M OR RISTOWN, NEW JERSEY"
120 PRINT:PRINT:PRINT
210 DIM S(8)
220 PRINT "WELCOME TO SOUTH P OR TLAND HIGH RACETRACK"
...
280 PRINT"MAY BET ANY + AMOUNT UNDER 100000 ON ON E H OR SE."
290 PRINT "DURING THE RACE, A H OR SE WILL BE SHOWN BY ITS"
300 PRINT"NUMBER.  THE H OR SES RACE DOWN THE PAPER!"
310 PRINT
...
590 NEXT N
600 PRINT"--------------------------------------------------"
610 PRINT "PLACE YOUR BETS...H OR SE # THEN AMOUNT"
620 FOR J=1 TO C
630 PRINT W$(J);
640 INPUT Q(J),P(J)
...
1290 LET F=M(I)
1300 PRINT
1310 PRINT Z9;"PLACE H OR SE NO.";F,"AT ";R/D(F);":1"
1312 LET Z9=Z9+1
1320  NEXT I
1330 FOR J=1 TO C
