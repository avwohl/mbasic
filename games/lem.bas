...
8 REM L AND ING IS SIMILAR TO THAT OF THE APOLLO PROGRAM.
...
140 PRINT
145 PRINT "LUNAR L AND ING SIMULATION"
150 PRINT
155 PRINT "HAVE YOU FLOWN AN APOLLO/LEM MISSION BEF OR E";
160 PRINT " (YES OR NO)";
165 INPUT Q$
...
315 PRINT
320 PRINT "  YOU ARE ON A LUNAR L AND ING MISSION.  AS THE PILOT OF"
325 PRINT "THE LUNAR EXCURSION MODULE, YOU WILL BE EXPECTED TO"
330 PRINT "GIVE CERTAIN COMM AND S TO THE MODULE NAVIGATION SYSTEM."
335 PRINT "THE ON-BOARD COMPUTER WILL GIVE A RUNNING ACCOUNT"
340 PRINT "OF INF OR MATION NEEDED TO NAVIGATE THE SHIP."
345 PRINT
350 PRINT
...
525 PRINT "TO AB OR T THE MISSION AT ANY TIME, ENTER 0,0,0"
530 PRINT
535 PRINT "OUTPUT: TOTAL TIME IN ELAPSED SECONDS"
540 PRINT "        HEIGHT IN ";M$
545 PRINT "        DISTANCE FROM L AND ING SITE IN ";M$
550 PRINT "        VERTICAL VELOCITY IN ";M$;"/SECOND"
555 PRINT "        H OR IZONTAL VELOCITY IN ";M$;"/SECOND"
...
990 GOTO 575
995 PRINT
1000 PRINT "TRANQUILITY BASE HERE -- THE EAGLE HAS L AND ED."
1005 PRINT "CONGRATULATIONS -- THERE WAS NO SPACECRAFT DAMAGE."
1010 PRINT "YOU MAY NOW PROCEED WITH SURFACE EXPL OR ATION."
1015 GOTO 1100
1020 PRINT
1025 PRINT "CRASH !!!!!!!!!!!!!!!!"
...
1075 PRINT
1080 PRINT "BUT MISSED THE L AND ING SITE BY";ABS(D/G5);N$;"."
1085 GOTO 1100
1090 PRINT
