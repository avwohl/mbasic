...
90 PRINT
100 PRINT "BY TYPING THE NUMBER C OR RESPONDING TO THE POSITION OF THE"
110 PRINT "LETTER ON SOME NUMBERS, ON E POSITION WILL CHANGE, ON"
...
690 PRINT "VERY GOOD.  YOU GUESSED IT IN ON LY";C;"GUESSES."
700 GOTO 720
