...
140 PRINT"R AND OM DECISION OF THE COMPUTER. THE FIELD OF PLAY IS A"
...
180 PRINT"THE GAME IS TO GET TO LOCATION 3,3,3. ON E MINOR DETAIL:"
190 PRINT"THE COMPUTER WILL PICK, AT R AND OM, 5 LOCATIONS AT WHICH"
200 PRINT"IT WILL PLANT LAND MINES. IF YOU HIT ON E OF THESE LOCATIONS"
210 PRINT"YOU LOSE. ON E OTHER DETAIL: YOU MAY MOVE ON LY ON E SPACE "
220 PRINT"IN ON E DIRECTION EACH MOVE. FOR  EXAMPLE: FROM 1,1,2 YOU"
...
310 PRINT
320 PRINT"WHEN STATING THE AMOUNT OF A WAGER, PRINT ON LY THE NUMBER"
