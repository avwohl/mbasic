...
5 PRINT "AN EIGHTEEN HOLE CHAMPIONSHIP LAYOUT LOCATED A SH OR T"
6 PRINT "DISTANCE FROM SCENIC DOWNTOWN M OR RISTOWN.  THE"
...
60 S2=0
70 F=1
80 PRINT "WHAT IS YOUR H AND ICAP";
90 INPUT H:PRINT
...
140 PRINT "WHICH ON E (ON LY ON E) IS YOUR W OR ST";
150 INPUT T:PRINT
160 IF T>5 THEN 120
170 S1=0
210 REM
...
260 K=0
270 IF F=1 THEN 310
290 PRINT "YOUR SC OR E ON HOLE";F-1;"WAS";S1
291 GOTO 1750
...
465 GOTO 1690
470 PRINT "PGA H AND ICAPS RANGE FROM 0 TO 30."
472 GOTO 80
480 PRINT "FAIRWAY."
490 GOTO 1690
500 PRINT "ROUGH."
