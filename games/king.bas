...
34 PRINT "FOR ESTS, HUNTING, FISHING, ETC. HALF YOUR LAND IS FARM LAND"
36 PRINT "WHICH ALSO HAS AN EXCELLENT MINERAL CONTENT AND MAY BE SOLD"
38 PRINT "TO FOR EIGN INDUSTRY (STRIP MINING) WHO IMP OR T AND SUPP OR T"
40 PRINT "THEIR OWN W OR KERS. CROPS COST BETWEEN 10 AND 15 RALLODS PER"
...
120 IF C=0 THEN 140
130 PRINT INT(C);"FOR EIGN W OR KERS, ";
...
230 PRINT "***  THINK AGAIN. YOU ON LY HAVE";D-1000;"SQUARE MILES OF FARM LAND."
240 IF X<>0 THEN 200
250 PRINT:PRINT "(FOR EIGN INDUSTRY WILL ON LY BUY FARM LAND BECAUSE"
260 PRINT "FOR EST LAND IS UNECONOMICAL TO STRIP MINE DUE TO TREES,"
...
350 IF I<A THEN 400
360 IF I=A THEN 380
370 PRINT "   THINK AGAIN. YOU'VE ON LY";A;" RALLODS IN THE TREASURY"
375 GOTO 320
380 J=0
390 K=0
395 A=0
...
423 PRINT "   S OR RY, BUT EACH COUNTRYMAN CAN ON LY PLANT 2 SQ. MILES."
424 GOTO 410
426 IF J<=D-1000 THEN 430
427 PRINT "   S OR RY, BUT YOU'VE ON LY";D-1000;"SQ. MILES OF FARM LAND."
428 GOTO 410
430 U1=INT(J*V9)
435 IF U1<A THEN 500
440 IF U1=A THEN 490
450 PRINT "   THINK AGAIN. YOU'VE ON LY";A;" RALLODS LEFT IN THE TREASURY."
460 GOTO 410
490 K=0
495 A=0
499 GOTO 1000
...
540 PRINT "   THINK AGAIN. YOU ON LY HAVE ";A;" RALLODS REMAINING."
550 GOTO 510
...
1165 GOTO 1200
1170 PRINT "   YOU WERE FOR CED TO SPEND";INT((F1+(B-(I/100)))*9);
1172 PRINT "RALLODS ON FUNERAL EXPENSES"
1174 B5=INT(F1+(B-(I/100)))
1175 A=INT(A-((F1+(B-(I/100)))*9))
1176 GOTO 1185
1180 PRINT "   YOU WERE FOR CED TO SPEND ";INT(F1*9);"RALLODS ON ";
...
1226 C1=C1+20
1230 PRINT C1;"W OR KERS CAME TO THE COUNTRY AND";
...
1365 PRINT "AIR AND WATER POLLUTION FROM FOR EIGN INDUSTRY.)"
1370 Q=INT((J-U2)*(W/2))
...
1550 PRINT
1552 PRINT
1560 PRINT "THE NUMBER OF FOR EIGN W OR KERS HAS EXCEEDED THE NUMBER"
1562 PRINT "OF COUNTRYMEN. AS A MIN OR ITY, THEY HAVE REVOLTED AND"
...
1600 PRINT
1602 PRINT
1610 PRINT B5;"COUNTRYMEN DIED IN ON E YEAR!!!!!"
1615 PRINT "DUE TO THIS EXTREME MISMANAGEMENT, YOU HAVE NOT ON LY"
...
1700 PRINT
1702 PRINT
1710 PRINT "OVER ON E THIRD OF THE POPULTATION HAS DIED SINCE YOU"
...
1965 PRINT "   COME ON, YOUR TERM IN OFFICE IS ON LY";N5;"YEARS."
1967 GOTO 1960
...
1997 PRINT "   AND 10,000 SQ. MILES OF FOR EST LAND."
1998 GOTO 1990
2000 X5=X5+1
2020 B5=0
2040 GOTO 100
