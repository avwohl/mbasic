...
300 PRINT "ON ANY TURN: 4 (OVER THE H OR NS), 5 (IN THE CHEST)."
310 PRINT "BUT IF I WERE YOU,"
320 PRINT "I WOULDN'T TRY IT BEF OR E THE SEVENTH PASS."
330 PRINT
...
370 PRINT
380 PRINT "THE BETTER THE JOB THE PICAD OR ES AND T OR EAD OR ES DO,"
...
820 IF E<3 THEN 850
830 PRINT "DON'T PANIC, YOU IDIOT!  PUT DOWN A C OR RECT NUMBER"
840 GOTO 800
850 REM
860 IF E=0 THEN 920
870 IF E=1 THEN 900
...
960 PRINT "THE BULL HAS G OR ED YOU!"
...
1090 D(4)=2
1100 GOTO 660
1110 PRINT "YOU ARE G OR ED AGAIN!"
1120 GOTO 970
1130 REM
1140 Z=1
...
1190 PRINT "YOU PANICKED.  THE BULL G OR ED YOU."
1220 GOTO 970
...
1530 PRINT "OLE!"
1540 GOTO 1580
1550 PRINT "ON E EAR OF THE BULL."
1560 GOTO 1580
...
1800 IF A$="T OR EAD" THEN 1820
1810 PRINT "ON E OF THE H OR SES OF THE ";A$;B$;" WAS KILLED."
1820 ON FNA(K) GOTO 1830,1850
1830 PRINT "ON E OF THE ";A$;B$;" WAS KILLED."
1840 GOTO 1900
1850 PRINT "NO ";A$;B$;" WERE KILLED."
1860 GOTO 1900
1870 IF A$="T OR EAD" THEN 1890
1880 PRINT FNA(K);"OF THE H OR SES OF THE ";A$;B$;" KILLED."
...
1970 PRINT "INC OR RECT ANSWER - - PLEASE TYPE 'YES' OR 'NO'."
1980 GOTO 1930
1990 Z1=1
2000 GOTO 2020
2010 Z1=2
