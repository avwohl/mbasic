...
90 PRINT "SURFACE CO OR DINATES; THE THIRD IS THE DEPTH."
...
200 PRINT : PRINT "YOU HAVE BEEN T OR PEDOED!  AB AND ON SHIP!"
...
500 PRINT "SONAR REP OR TS SHOT WAS ";
510 IF Y>B THEN PRINT "N OR TH";
